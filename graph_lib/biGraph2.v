...
(* *)
|Back_to_yes : forall (u w1 w2: V ) (e1 e2 e3: E)(cl : list V) (p :list E) (v1: Vstateb),
      dst gra e3 = w2 -> In e3 M ->
      v1 u = true -> max_conn u v1 = O -> 
            In e1 M ->  ~In e2 M -> 
              src gra e1 = w1 -> dst gra e1 = u  -> src gra e2 = w2 -> dst gra e2 = w1 ->
           cross_step (v1, (u, e1::(e2::(e3::p)))) ( Vstateb_update_fl v1 (list_sub cl (e_to_v p) ) , (w2 ,e3::p))
(**回溯到上一个匹配点*) 
|Back_to_no : forall (u w1 w2 : V) (e1 e2 : E) (cl: list V) (p : list E ) (v1 : Vstateb) ,
     v1 u = true -> max_conn u v1 = O -> 
           In e1 M ->  ~In e2 M -> cl = con u ->
             src gra e1 = w1 -> dst gra e1 = u  -> src gra e2 = w2 -> dst gra e2 = w1 ->
           cross_step (v1, (u, e1::(e2::nil))) ( Vstateb_update_fl v1 (list_sub cl (e_to_v p) ) , (w2 ,nil))
(** 回溯到初始状态即一个点*)    .
...
Lemma notmatching : forall v e M, src gra e = v -> In e M -> ~ Ma v M =None.
Proof.
  intros.
  unfold not.
  intros. induction M0.
...
Proof.
  intros.
  induction H.
  - inversion H0. unfold not in H13. apply H13 in H5.  inversion H5.
  - inversion H0. unfold not in H16. apply H16 in H8.  inversion H8.
...
Theorem aug_to_greater_match :
  forall (v1: list V) (e1: list E) v st, is_matching v1 e1 -> cross_halt st -> multi_cstep (Vstateb_update default_Vstateb v, (v, nil)) st -> In v v1 -> exists (v2: list V) (e2: list E), is_matching v2 e2 /\ length(e2) > length(e1).
Proof.
  intros.
(* 
